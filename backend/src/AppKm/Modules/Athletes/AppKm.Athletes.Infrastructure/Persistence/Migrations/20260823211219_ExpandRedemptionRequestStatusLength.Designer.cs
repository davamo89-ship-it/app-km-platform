...
namespace AppKm.Athletes.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260823211219_ExpandRedemptionRequestStatusLength")]
    partial class ExpandRedemptionRequestStatusLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppKm.Athletes.Domain.Aggregates.Merchants.Merchant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("UX_merchants_user_id");

                    b.ToTable("merchants", "athletes");
                });
